...
carro.adicionarPessoas = function(numero) {
  ...
  var pluralOuSingular = carro.quantidadePessoas !== 1 ? 's' : '';

  if( carro.quantidadePessoas === carro.assentos && numero > 0) {
    return 'O carro já está lotado!';
  }

  if( numero > lugaresDisponiveis ) {
    pluralOuSingular = lugaresDisponiveis !== 1 ? 's' : '';
    
    return 'Só cabe mais ' + lugaresDisponiveis + ' pessoa' + pluralOuSingular + '!';
  } 
  ...
  return 'Já temos ' + carro.quantidadePessoas + ' pessoa' + pluralOuSingular + ' no carro!';
};
...
carro.obterMarcaModelo(); // 'Esse carro é um Dodge Viper 8.4 SRT'
